        ...
        $$('.form-pagebreak').each(function (page, i) {
            ...
            section.select('.form-pagebreak-next').invoke('observe', 'click', function () { // When next button is clicked
                ...
                if ((JotForm.validateAll(form, section)) || getQuerystring('qp') !== "") {
                    trackExecution('page-validation-isvalid');
        ...
        $A(JotForm.forms).each(function (form) { // for each JotForm form on the page
            ...
            form.observe('submit', function (e) {
                try {
                    ...
                    trackExecution('submit-validation-isvalid');
                    ...
                    trackExecution('submit-validation-error');
                    JotForm.error(err);
                    e.stop();
...
function trackSubmitSource(value) {
    var submitSourceTrackerElement = document.getElementById('submitSource');
    if (submitSourceTrackerElement) {
        submitSourceTrackerElement.value = value + (new Date()).getTime();
    }
}
