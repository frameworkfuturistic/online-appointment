...
<head>
  ...
  <link rel="shortcut icon" href="http://sjhrc.in/images/hospitallogo.png">
  <link rel="apple-touch-icon" href="http://sjhrc.in/images/hospitallogo.png">
  <script>
...
" />
  ...
  <link type="text/css" rel="stylesheet" href="https://cdn03.jotfor.ms/css/styles/payment/payment_styles.css?3.3.46852" />
  <link type="text/css" rel="stylesheet" href="https://cdn01.jotfor.ms/css/styles/payment/payment_feature.css?3.3.46852" />
  <link type="text/css" rel="stylesheet" href="https://cdn02.jotfor.ms/stylebuilder/donationBox.css?v=3.3.46852">
  ...
  <script src="https://cdn03.jotfor.ms/static/prototype.forms.js?3.3.46852" type="text/javascript"></script>
  <script src="https://cdn01.jotfor.ms/static/jotform.forms.js?3.3.46852" type="text/javascript"></script>
  <script src="https://cdn02.jotfor.ms/js/vendor/jquery-1.8.0.min.js?v=3.3.46852" type="text/javascript"></script>
  <script defer src="https://cdn03.jotfor.ms/js/vendor/maskedinput.min.js?v=3.3.46852" type="text/javascript"></script>
  <script defer src="https://cdn01.jotfor.ms/js/vendor/jquery.maskedinput.min.js?v=3.3.46852" type="text/javascript"></script>
  <script defer src="https://cdn02.jotfor.ms//js/punycode-1.4.1.min.js"></script>
  <script src="https://cdn03.jotfor.ms/js/payments/validategateways.js?v=3.3.46852" type="text/javascript"></script>
  <script src="https://cdn01.jotfor.ms/s/umd/9364d29942f/for-appointment-field.js?v=3.3.46852" type="text/javascript"></script>
  <script type="text/javascript">
    ...
    JotForm.init(function() {
      ...
      window.initializeAppointment({
        "text": {
          "text": "Question",
          "value": "Preferred Appointment Date "
        },
        "labelAlign": {
          "text": "Label Align",
          "value": "Top",
        ...
        "qname": {
          "toolbar": false,
          "value": "q25_preferredAppointment"
        },
        "cdnconfig": {
    ...
    setTimeout(function() {
      JotForm.paymentExtrasOnTheFly([null, null, {
        ...
        "qid": "19",
        "text": "Doctor Appointment Request Form",
        "type": "control_head"
      }, {
        "name": "address",
        "qid": "20",
        ...
        "name": "whichProcedure",
        "qid": "29",
        "text": "Which procedure do you want to make an appointment for?",
        "type": "control_dropdown"
      }, {
        "name": "asset203163A1Cc30B6D",
        "qid": "30",
        "text": "jagannath.653a0260382858.25079750",
        "type": "control_image"
      }, {
        "name": "input31",
        "qid": "31",
...
<body>
  <form class="jotform-form" action="#" method="post" name="form_232980825800458" id="232980825800458" accept-charset="utf-8" autocomplete="on">
    <input type="hidden" name="formID" value="232980825800458" /><input type="hidden" id="JWTContainer" value="" /><input type="hidden" id="cardinalOrderNumber" value="" />
    <input type="hidden" id="jsExecutionTracker" name="jsExecutionTracker" value="start-1698300648695" /><input type="hidden" id="submitSource" name="submitSource" value="unknown" />
    <div role="main" class="form-all">
      <ul class="form-section page-section">
        <li class="form-line form-line-column form-col-1" data-type="control_image" id="id_30">
          <div id="cid_30" class="form-input-wide" data-layout="full"> <img alt="Dummy healthcare company logo called ACME Care" loading="lazy" class="form-image" style="border:0" src="http://sjhrc.in/images/hospitallogo.png" tabindex="0" height="99px" width="102px" data-component="image" role="presentation" /> </div>
        </li>
          ...
          <div id="cid_31" class="form-input-wide" data-layout="full">
            <div id="text_31" class="form-html" data-component="text" tabindex="0">
              <div style="line-height: 18px; text-align: right; padding-top: 24px;">
                <div style="font-size: 12pt;"><strong>Shree Jagannath Hospital & Research Center</strong></div>
                <div style="font-size: 10pt;"></div>
                <div style="line-height: 14px;">
                  <div style="font-size: 8pt;">sjhrc.ranchi@gmail.com</div>
                  <div style="font-size: 8pt;">http://sjhrc.in</div>
                  <div style="font-size: 8pt;">+91 8987999200</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <li id="cid_19" class="form-input-wide" data-type="control_head">
          <div class="form-header-group  header-large">
            <div class="header-text httac htvam">
              <h1 id="header_19" class="form-header" data-component="header">Doctor Appointment Request Form</h1>
              <div id="subHeader_19" class="form-subHeader">Fill the form below and we will get back soon to you for
                more updates and plan your appointment.</div>
            </div>
          </div>
        </li>
        <li class="form-line" data-type="control_fullname" id="id_26"><label class="form-label form-label-top form-label-auto" id="label_26" for="first_26" aria-hidden="false"> Name
          </label>
          <div id="cid_26" class="form-input-wide" data-layout="full">
            <div data-wrapper-react="true">
              <span class="form-sub-label-container" style="vertical-align:top" data-input-type="first">
                <input type="text" id="first_26" name="q26_name[first]" class="form-textbox" data-defaultvalue="" autoComplete="section-input_26 given-name" size="10" value="" data-component="first" aria-labelledby="label_26 sublabel_26_first" /><label class="form-sub-label" for="first_26" id="sublabel_26_first" style="min-height:13px" aria-hidden="false">First Name</label></span><span class="form-sub-label-container" style="vertical-align:top" data-input-type="last"><input type="text" id="last_26" name="q26_name[last]" class="form-textbox" data-defaultvalue="" autoComplete="section-input_26 family-name" size="15" value="" data-component="last" aria-labelledby="label_26 sublabel_26_last" /><label class="form-sub-label" for="last_26" id="sublabel_26_last" style="min-height:13px" aria-hidden="false">Last Name</label></span>
            </div>
          </div>
        </li>
        <li class="form-line" data-type="control_birthdate" id="id_9"><label class="form-label form-label-top form-label-auto" id="label_9" for="input_9" aria-hidden="false"> Date of
            Birth </label>
          <div id="cid_9" class="form-input-wide" data-layout="full">
            <div data-wrapper-react="true"><span class="form-sub-label-container" style="vertical-align:top"><select name="q9_dateOf[day]" id="input_9_day" class="form-dropdown" data-component="birthdate-day" aria-labelledby="label_9 sublabel_9_day">
                  <option></option>
                ...
                </select><label class="form-sub-label" for="input_9_day" id="sublabel_9_day" style="min-height:13px" aria-hidden="false">Day</label></span><span class="form-sub-label-container" style="vertical-align:top"><select name="q9_dateOf[month]" id="input_9_month" class="form-dropdown" data-component="birthdate-month" aria-labelledby="label_9 sublabel_9_month">
                  <option></option>
                ...
                </select><label class="form-sub-label" for="input_9_month" id="sublabel_9_month" style="min-height:13px" aria-hidden="false">Month</label></span><span class="form-sub-label-container" style="vertical-align:top"><select name="q9_dateOf[year]" id="input_9_year" class="form-dropdown" data-component="birthdate-year" aria-labelledby="label_9 sublabel_9_year">
                  <option></option>
                ...
                </select><label class="form-sub-label" for="input_9_year" id="sublabel_9_year" style="min-height:13px" aria-hidden="false">Year</label></span></div>
          </div>
        </li>
        <li class="form-line form-line-column form-col-1" data-type="control_dropdown" id="id_22"><label class="form-label form-label-top form-label-auto" id="label_22" for="input_22" aria-hidden="false"> Gender
          </label>
          <div id="cid_22" class="form-input-wide" data-layout="half"> <select class="form-dropdown" id="input_22" name="q22_gender" style="width:310px" data-component="dropdown" aria-label="Gender">
        ...
        <li class="form-line" data-type="control_address" id="id_20"><label class="form-label form-label-top form-label-auto" id="label_20" for="input_20_addr_line1" aria-hidden="false"> Address </label>
          <div id="cid_20" class="form-input-wide" data-layout="full">
            <div summary="" class="form-address-table jsTest-addressField">
              <div class="form-address-line-wrapper jsTest-address-line-wrapperField"><span class="form-address-line form-address-street-line jsTest-address-lineField"><span class="form-sub-label-container" style="vertical-align:top"><input type="text" id="input_20_addr_line1" name="q20_address[addr_line1]" class="form-textbox form-address-line" data-defaultvalue="" autoComplete="section-input_20 address-line1" value="" data-component="address_line_1" aria-labelledby="label_20 sublabel_20_addr_line1" required="" /><label class="form-sub-label" for="input_20_addr_line1" id="sublabel_20_addr_line1" style="min-height:13px" aria-hidden="false">Street Address</label></span></span></div>
              <div class="form-address-line-wrapper jsTest-address-line-wrapperField"><span class="form-address-line form-address-street-line jsTest-address-lineField"><span class="form-sub-label-container" style="vertical-align:top"><input type="text" id="input_20_addr_line2" name="q20_address[addr_line2]" class="form-textbox form-address-line" data-defaultvalue="" autoComplete="section-input_20 address-line2" value="" data-component="address_line_2" aria-labelledby="label_20 sublabel_20_addr_line2" /><label class="form-sub-label" for="input_20_addr_line2" id="sublabel_20_addr_line2" style="min-height:13px" aria-hidden="false">Street Address Line 2</label></span></span></div>
              <div class="form-address-line-wrapper jsTest-address-line-wrapperField"><span class="form-address-line form-address-city-line jsTest-address-lineField "><span class="form-sub-label-container" style="vertical-align:top"><input type="text" id="input_20_city" name="q20_address[city]" class="form-textbox form-address-city" data-defaultvalue="" autoComplete="section-input_20 address-level2" value="" data-component="city" aria-labelledby="label_20 sublabel_20_city" required="" /><label class="form-sub-label" for="input_20_city" id="sublabel_20_city" style="min-height:13px" aria-hidden="false">City</label></span></span><span class="form-address-line form-address-state-line jsTest-address-lineField "><span class="form-sub-label-container" style="vertical-align:top"><input type="text" id="input_20_state" name="q20_address[state]" class="form-textbox form-address-state" data-defaultvalue="" autoComplete="section-input_20 address-level1" value="" data-component="state" aria-labelledby="label_20 sublabel_20_state" required="" /><label class="form-sub-label" for="input_20_state" id="sublabel_20_state" style="min-height:13px" aria-hidden="false">State /
                      Province</label></span></span></div>
              <div class="form-address-line-wrapper jsTest-address-line-wrapperField"><span class="form-address-line form-address-zip-line jsTest-address-lineField "><span class="form-sub-label-container" style="vertical-align:top"><input type="text" id="input_20_postal" name="q20_address[postal]" class="form-textbox form-address-postal" data-defaultvalue="" autoComplete="section-input_20 postal-code" value="" data-component="zip" aria-labelledby="label_20 sublabel_20_postal" required="" /><label class="form-sub-label" for="input_20_postal" id="sublabel_20_postal" style="min-height:13px" aria-hidden="false">Postal /
                      Zip Code</label></span></span></div>
            </div>
          </div>
        </li>
        <li class="form-line" data-type="control_email" id="id_24"><label class="form-label form-label-top form-label-auto" id="label_24" for="input_24" aria-hidden="false"> Email
          </label>
          <div id="cid_24" class="form-input-wide" data-layout="half"> <span class="form-sub-label-container" style="vertical-align:top"><input type="email" id="input_24" name="q24_email" class="form-textbox validate[Email]" data-defaultvalue="" autoComplete="section-input_24 email" style="width:310px" size="310" value="" placeholder="ex: myname@example.com" data-component="email" aria-labelledby="label_24 sublabel_input_24" /><label class="form-sub-label" for="input_24" id="sublabel_input_24" style="min-height:13px" aria-hidden="false">example@example.com</label></span>
          </div>
        </li>
        <li class="form-line" data-type="control_radio" id="id_10"><label class="form-label form-label-top" id="label_10" for="input_10" aria-hidden="false"> Have you ever applied to our facility before? </label>
          <div id="cid_10" class="form-input-wide" data-layout="full">
            <div class="form-multiple-column" data-columncount="2" role="group" aria-labelledby="label_10" data-component="radio"><span class="form-radio-item"><span class="dragger-item"></span><input type="radio" aria-describedby="label_10" class="form-radio" id="input_10_0" name="q10_haveYou" value="Yes" /><label id="label_input_10_0" for="input_10_0">Yes</label></span><span class="form-radio-item"><span class="dragger-item"></span><input type="radio" aria-describedby="label_10" class="form-radio" id="input_10_1" name="q10_haveYou" value="No" /><label id="label_input_10_1" for="input_10_1">No</label></span></div>
          </div>
        </li>
        <li class="form-line" data-type="control_textbox" id="id_28"><label class="form-label form-label-top form-label-auto" id="label_28" for="input_28" aria-hidden="false"> Which
            department would you like to get an appointment from? </label>
          <div id="cid_28" class="form-input-wide" data-layout="half">
            <select class="form-dropdown" id="input_29" name="q29_whichProcedure" style="width:310px" data-component="dropdown" aria-label="Which procedure do you want to make an appointment for?">
              <option value="">Please Select</option>
        ...
        <li class="form-line" data-type="control_dropdown" id="id_29"><label class="form-label form-label-top form-label-auto" id="label_29" for="input_29" aria-hidden="false"> Which
            procedure do you want to make an appointment for? </label>
        ...
        <li class="form-line" data-type="control_divider" id="id_27">
          <div id="cid_27" class="form-input-wide" data-layout="full">
            <div class="divider" data-component="divider" style="border-bottom-width:1px;border-bottom-style:solid;border-color:#ecedf3;height:1px;margin-left:0px;margin-right:0px;margin-top:5px;margin-bottom:5px">
            </div>
          </div>
        </li>
        <li class="form-line" data-type="control_appointment" id="id_25"><label class="form-label form-label-top" id="label_25" for="input_25" aria-hidden="false"> Preferred Appointment Date </label>
          <input type="date" class="form-textbox" id="appointmentDate" name="appointmentDate">
        </li>
        <li class="form-line" data-type="control_button" id="id_2">
          <div id="cid_2" class="form-input-wide" data-layout="full">
            <div data-align="center" class="form-buttons-wrapper form-buttons-center   jsTest-button-wrapperField">
              <button id="input_2" type="submit" class="form-submit-button form-submit-button-simple_black submit-button jf-form-buttons jsTest-submitField" data-component="button" data-content="">Submit Form</button>
            </div>
          </div>
        </li>
    ...
    </script><input type="hidden" class="simple_spc" id="simple_spc" name="simple_spc" value="232980825800458" />
    <script type="text/javascript">
      var all_spc = document.querySelectorAll("form[id='232980825800458'] .si" + "mple" + "_spc");
      for (var i = 0; i < all_spc.length; i++) {
        all_spc[i].value = "232980825800458-232980825800458";
      }
    </script>
  </form>
  <script type="text/javascript">
